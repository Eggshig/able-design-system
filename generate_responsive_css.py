...
def flatten_dict(d, parent_key='', sep='-'):
    ...
    for k, v in d.items():
        safe_k = k.replace(' ', '-')
        new_key = parent_key + sep + safe_k if parent_key else safe_k
...
# --- Generate Responsive CSS files ---
responsive_token_sets = {
...
for name, units in responsive_token_sets.items():
...
print("Responsive CSS files have been generated successfully.")
